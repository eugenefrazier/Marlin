...
#define STRING_CONFIG_H_AUTHOR "(Giorno, Giovarna, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Jojo's Bizzare Adventure"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, 6.5, -1.79 }
